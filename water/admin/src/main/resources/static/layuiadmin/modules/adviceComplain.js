...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/adviceComplain/list?incidentType=McsItemType.AdviceComplaint' //模拟接口11
    ,cols: [[
...
//      ,{field: 'conName', minWidth: 100, title: '联系人'}
      ...
      ,{field: 'email', minWidth: 100, title: '电子邮箱'}
      ,{field: 'fyly', minWidth: 100, title: '反应来源'}
 //     ,{field: 'fyqm', minWidth: 100, title: '反应区名'}
      ,{field: 'fyxs', minWidth: 100, title: '反应形式'}
//      ,{field: 'fylb', minWidth: 100, title: '反应类别'}
      ,{field: 'fylb', minWidth: 100, title: '反应类别',templet: function(d){
          	  if(d.fylb == '01'){
          		  return '业务咨询';
          	  }else if (d.fylb == '02'){
          		return '表扬';
      ...
      ,{field: 'fynr', minWidth: 100, title: '反应内容'}
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '业务咨询、表扬、投诉、建议'
                ,content: '/home/adviceComplain/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
