...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/meterMove/list?incidentType=McsItemType.RepairMeterOutward' //模拟接口11
    ,cols: [[
...
//      ,{field: 'conName', minWidth: 100, title: '联系人'}
      ,{field: 'contactNumber', minWidth: 100, title: '联系电话'}
      ,{field: 'email', minWidth: 100, title: '电子邮箱'}
      ,{field: 'bookTime', minWidth: 100, title: '预约时间'}
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '水表外移'
                ,content: '/home/meterMove/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
