...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/cusChange/company/list?incidentType=McsItemType.CustomerCompanyInfoChange' //模拟接口11
    ,cols: [[
...
//      ,{field: 'applyPhone', minWidth: 100, title: '联系电话'}
      ,{field: 'mailAddress', minWidth: 100, title: '邮寄地址'}
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '单位信息变更'
                ,content: '/home/cusChange/company/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
  ...
  exports('customerChangeCompanyApply', {})
});	