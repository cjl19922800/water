...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/realName/company/list?incidentType=McsItemType.RealNameCompanyRegiste' //模拟接口11
    ,cols: [[
...
//      ,{field: 'conName', minWidth: 100, title: '联系人'}
      ,{field: 'proOwnerPhone', minWidth: 100, title: '联系电话'}
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '单位实名制'
                ,content: '/home/realName/company/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
