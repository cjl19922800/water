...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/accountCancel/list?incidentType=McsItemType.WriteOffAccount' //模拟接口11
    ,cols: [[
...
//      ,{field: 'conName', minWidth: 100, title: '联系人'}
      ,{field: 'contactNum', minWidth: 100, title: '联系电话'}
      ,{field: 'companyName', minWidth: 100, title: '公司名称'}
      ,{field: 'email', minWidth: 100, title: '电子邮箱'}
      ,{field: 'reason', minWidth: 100, title: '销户原因'}
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '水表拆表销户'
                ,content: '/home/accountCancel/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
