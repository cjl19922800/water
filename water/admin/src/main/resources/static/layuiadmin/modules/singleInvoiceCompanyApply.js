...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/singleInvoice/company/list?incidentType=McsItemType.ElecInvoiceCompanyObtain' //模拟接口11
    ,cols: [[
...
//      ,{field: 'conName', minWidth: 100, title: '联系人'}
      ...
      ,{field: 'account', minWidth: 100, title: '账期'}
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '单位电子发票单次获取'
                ,content: '/home/singleInvoice/company/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
  ...
  exports('singleInvoiceCompanyApply', {})
});	