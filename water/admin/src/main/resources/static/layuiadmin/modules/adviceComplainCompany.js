...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/adviceComplainCompany/list?incidentType=McsItemType.AdviceComplaintCompany' //模拟接口11
    ,cols: [[
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '业务咨询、表扬、投诉、建议'
                ,content: '/home/adviceComplainCompany/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
