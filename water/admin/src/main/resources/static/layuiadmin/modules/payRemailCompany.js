...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/payRemail/company/list?incidentType=McsItemType.PayNoticeCompanyRemail' //模拟接口11
    ,cols: [[
...
//      ,{field: 'conName', minWidth: 100, title: '联系人'}
       ,{field: 'addressee', minWidth: 100, title: '收件人'}
      ,{field: 'addPhone', minWidth: 100, title: '收件人联系电话'}
      ,{field: 'contactValue', minWidth: 100, title: '联系电话'}
       ,{field: 'noticeType', minWidth: 100, title: '通知单类型',templet: function(d){
          	  if(d.noticeType == '0'){
          		  return '纸质';
          	  }else{
          		return '电子';
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '单位补送缴费'
                ,content: '/home/payRemail/company/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
