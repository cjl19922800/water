...
layui.define(['table', 'form', 'element'], function(exports){
  ...
  table.render({
    ...
    ,url: '/home/singleInvoice/list?incidentType=McsItemType.ElecInvoiceObtain' //模拟接口11
    ,cols: [[
    ...
    table.on('tool(LAY-app-system-order)', function(obj){
        ...
        if(obj.event === 'edit'){
            ...
            layer.open({
                type: 2
                ,title: '居民电子发票单次获取'
                ,content: '/home/singleInvoice/detail?incidentId='+data.incidentId
                ,area: ['100%', '100%']
            	,btn: ['确定', '取消']
